      ...
      <div className="bg-gradient-to-r from-purple-700 to-indigo-800 text-white py-8 px-4">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          <div>
            ...
            <p className="text-purple-200 mt-1">Manage your events and bookings</p>
          </div>
          <Link
            to="/admin/create-event"
            className="flex items-center gap-2 bg-white text-purple-700 px-4 py-2 rounded-full font-semibold hover:bg-purple-50 transition"
          >
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          {statCards.map((card, index) => (
            <div key={index} className="bg-white rounded-2xl shadow-sm p-6 flex items-center gap-4">
            ...
            {recentEvents.length === 0 ? (
              <div className="text-center py-8">
                ...
                <Link to="/admin/create-event">
                  <button className="mt-3 bg-purple-600 text-white px-4 py-2 rounded-full text-sm hover:bg-purple-700 transition">
                    Create Event
                  </button>
                </Link>
              </div>
