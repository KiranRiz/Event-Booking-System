    ...
    <div className="min-h-screen">
      ...
      <div className="bg-gradient-to-r from-brand-900 to-brand-800 text-white py-8 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-orange-200 mt-1">{bookings.length} total bookings</p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        {filteredBookings.length === 0 ? (
          <div className="text-center py-20 theme-card rounded-2xl shadow-sm">
            ...
            <p className="text-theme-text-muted">Try changing your filters</p>
          </div>
        ) : (
          <div className="theme-card rounded-2xl shadow-sm overflow-hidden">

            {/* Table Header */}
            <div className="grid grid-cols-6 gap-4 p-4 bg-surface-soft border-b border-gray-100 text-sm font-semibold text-theme-text-muted">
              <div>Booking ID</div>
            ...
            <div className="divide-y divide-gray-50">
              {filteredBookings.map((booking) => (
                <div
                  key={booking._id}
                  className="grid grid-cols-6 gap-4 p-4 items-center hover:bg-surface-soft transition"
                >
